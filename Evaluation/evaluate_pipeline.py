...
if __name__ == '__main__':
    ...
    parser.add_argument("-r", "--result_df_path", help="Path to inferred Dataset", default = '', type = str)
    parser.add_argument("-o", "--output_path", help="Path to file to store metrics", default = '', type = str)
